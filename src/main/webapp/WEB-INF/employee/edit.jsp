...
<!-- 							<li class="nav-item">
		...
		<div style="border-bottom: 2px solid black;"></div>
	       <div class="col-5 my-3 container">
            <form:form action="/process/${id}/edit"  method="post" modelAttribute="employeeName">
                	<input type="hidden" name="_method" value="put"/>
				<form:hidden path="user"/>
				                
                <div class="form-group">
                    	<label>Hire Date:</label>
                        <form:input path="hireDate" class="form-control" type="date" placeholder="Hire Date"/>
               ...
               <div class="form-group">
                    <!-- <label>Name</label> -->
                        <form:input path="name" class="form-control mt-3" type="text" placeholder="Enter first and last name"/>
                ...
                <input type="submit" value="Edit Employee" class="btn btn-outline-success"/>
            </form:form>
        </div>
